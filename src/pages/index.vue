<template>
    <div class="w-screen">
        <div class="flex bg-neutral-800 border border-green-500 border-l-0 rounded-r-xl text-lg w-5/6 mb-6 items-center h-10">
        ...
        <div class="flex bg-neutral-800 border border-green-500 border-l-0 rounded-r-xl text-lg w-1/2 mb-6 items-center h-10">
