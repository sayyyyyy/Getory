<template>
    <div class="w-screen">
        <div class="flex bg-neutral-800 border border-green-500 border-l-0 rounded-r-xl text-lg w-80 min-w-fit mb-6 items-center justify-center h-10 lg:h-16 lg:w-1/3 lg:text-xl">
