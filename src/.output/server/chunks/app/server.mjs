import { getCurrentInstance, toRef, isRef, version, defineComponent, h, Suspense, nextTick, Transition, computed, provide, reactive, ref, resolveComponent, shallowRef, useSSRContext, createApp, defineAsyncComponent, onErrorCaptured, unref, inject, mergeProps } from 'vue';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index.38e37177.mjs').then((m) => m.default || m)
  },
  {
    name: (_c = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) != null ? _c : "search",
    path: (_d = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) != null ? _d : "/search",
    file: "/src/pages/search.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/search.38553838.mjs').then((m) => m.default || m)
  }
];
...
const _imports_0 = "" + globalThis.__publicAssetsURL("favicon.png");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex p-4 mb-8 items-center w-100 lg:p-10" }, _attrs))}><img class="w-10 h-10 lg:w-16 lg:h-16"${ssrRenderAttr("src", _imports_0)}><div class="flex ml-auto text-white items-center"><button class="bg-neutral-800 rounded-2xl drop-shadow-xl mr-2 p-2 h-4/5 text-sm lg:text-base lg:mr-6">${ssrInterpolate(_ctx.$t("random_btn"))}</button><form><select id="locale-select" class="cursor-pointer h-4/5 bg-inherit text-base lg:text-lg lg:mr-4"><option value="en">${ssrInterpolate(_ctx.$t("en"))}</option><option value="ja">${ssrInterpolate(_ctx.$t("ja"))}</option></select></form></div></div>`);
}
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/header_component.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-neutral-700" }, _attrs))}>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.5502948a.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useState as a, __nuxt_component_0$1 as b, createError as c, entry$1 as default, navigateTo as n, useNuxtApp as u };
